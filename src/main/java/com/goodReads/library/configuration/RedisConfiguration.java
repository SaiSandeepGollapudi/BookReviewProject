...
LettuceConnectionFactory lettuceConnectionFactory = new LettuceConnectionFactory();//for creating a connection, i.e. how spring should communicate with the app,
